 ...
 * Description: ...
 */
public class ThanhNienEntertainment extends Entertainment {
    public ThanhNienEntertainment() {
        super();
    }

    public ThanhNienEntertainment(String urlSource, String brand) throws Exception {
