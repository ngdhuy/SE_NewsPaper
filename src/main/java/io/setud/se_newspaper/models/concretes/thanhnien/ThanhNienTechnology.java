 ...
 * Description: ...
 */
public class ThanhNienTechnology extends Technology {
    public ThanhNienTechnology() {
        super();
    }

    public ThanhNienTechnology(String urlSource, String brand) throws Exception {
